...
export async function POST(req: NextRequest, context: RouteContext) {
  ...
  const generatorId = isRecord(body) && typeof body.generatorId === "string"
    ? body.generatorId.trim()
    : "";
  ...
  try {
    ...
    const res = await fetch(`${COLLECTIONS_API_URL}/generators/requests/${requestId}/cancel`, {
      method: "POST",
      headers: {
